...
\TODO{Phil - Shane - Glenn to clarify that SMAs can be for a single motif, or aggregate of multiple motifs.  We need to make clear that we apply both in this paper.}
