...
\multirow{3}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}\edison\\ (\nersc)\end{tabular}}} & \multirow{3}{*}{\begin{tabular}[c]{@{}c@{}}Cray XC30\\ 5,586 CNs\end{tabular}} & \scratchone               & 2.2 PiB       & 48 GB/sec              \\ \cline{3-5} 
...
\TODO{add OST information as a second row in Table \ref{tab:platform-descriptions}}
\TODO{is there something we can reference out the BG/Q ION architecture?  UMAMI, an IBM Redbook, or footnotes + URLs to ALCF website}
...
\TODO{any way to cite the Fail Slow at Scale here without creating a new thread for reviewers to pull at?}
