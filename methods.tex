...
For data sources that produce time-resolved data (e.g., LMT samples workload data at five-second intervals), we calculate the sum, minimum, maximum, and average value of the data generated over the duration of the job and define those reduced scalars as attributes of the feature vector.
