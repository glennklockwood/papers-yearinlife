...
\item \textbf{Resource manager monitoring}: Resource managers such as Slurm~\cite{2003slurm} often keep a detailed accounting of all jobs executing on a particular system, such as the size of the job and its placement across available compute nodes.
\end{itemize}
