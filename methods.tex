...
eight I/O nodes allocated to each job (for \mira).  \TODO{What does that
last sentence above mean?  First half is about FS striping, second half is
about forwarding layer resources?}
