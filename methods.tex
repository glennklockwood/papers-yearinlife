...
\TODO{Rely on PDSW paper and upcoming CUG submission on TOKIO to provide lower level details, summarize high-level concepts most relevant to this study.  That paper's ref is ~\cite{Lockwood2018tokio}.}
...
An overview of the fraction of peak performance for two of the five systems tested is shown in Figure \ref{fig:summary-heatmap}.
