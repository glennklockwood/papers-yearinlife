...
\item We show that the baseline performance and variation change over time.
...
% 
% ^.
\item The nature of correlations between I/O performance and system metrics also change over
