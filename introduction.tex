...
\item We have shown that the baseline performance and the performance variation changes over time.
...
% 
% ^.
\item At different times measured metrics associated with I/O performance  can have different characteristics. We demonstrate that high CPU load can correlate with favorable performance under healthy file system conditions, and it can coincide with unfavorable performance when non-I/O workloads are impacting storage servers.
