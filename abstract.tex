...
comprehensive I/O performance data set assembled via multiple continuous
instrumentation methods across a full year of production storage activity,
...
focused investigation of both long-term trends and transient anomolies,
...
fluctuations with a variety of different underlying causes.  Large-scale I/O
performance and variability is not constant, and instrumentation,
analysis methods, and performance models must adapt to prevailing
conditions in order to effectively derive actionable insight from I/O
instrumentation.
