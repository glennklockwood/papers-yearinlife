...
Since we have a number of positive and negative classifications as well as a p-value for each divergence region, we can apply the binomial test to each fraction expressed in Fig. \ref{fig:contributors-bad-by-system}
