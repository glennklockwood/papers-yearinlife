...
To address this, we calculate the probability of observing the results in Fig. \ref{fig:contributors-bad-by-system} in the absence of any underlying relationship using a one-tailed binomial test\footnote{
This probability is the p-value of the distribution
We use the number of positive and negative classifications and the assumption that.
