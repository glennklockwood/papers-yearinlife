...
While we chose a very simple classification criteria based on $\min{a}$, this process can be applied using any classification methodology that can produce statistically meaningful classifications of attributes that 
