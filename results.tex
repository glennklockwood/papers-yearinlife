...
Because divergence regions contain observations of similaperformance by definition, this anomalous observation is truly anomalous--it is in a region where the typical performance is defined, but it is also divergent from that.
