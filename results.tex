...
As with the longer-term performance divergence, high contention for bandwidth is found to also cause short-term performance transients. and IOPS are the metrics that most frequently coincide with abnormally poor performance.
