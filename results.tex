...
data servers during anomalous jobs to a less significant degree.  This is
...
While we chose a very simple classification criteria based on $\min{a}$, this process could be applied using any classification methodology that identifies relationships between feature vectors in a divergence region and quantifies the associated statistical significance.
